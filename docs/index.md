...
features:
  - icon: ✨
    title: 强大的通用性
    details: Systematize Design 足以胜任绝大部分场景，无论在线文档，设计工具，亦或管理后台，都可让你如鱼得水开始设计工作，且不会带来任何体验上的不适。
  - icon: 🔑
    title: 易于自定义
    details: 我们提供了多种方式来为 Systematize Design 附上属于您的特征，例如「主题色卡」，「圆角变化标准」，合理利用这些工具，可快速使 Systematize Design 加入您的设计风格中。
  - icon: 👌
    title: 足够开放
